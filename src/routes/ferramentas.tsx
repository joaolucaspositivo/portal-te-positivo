              ...
              {filtered.map((f: any) => (
                <div key={f.id} className="p-6 rounded-xl border bg-card flex flex-col">
                  ...
                  <div className="text-xs text-muted-foreground space-y-1 mb-4">
                    {f.publico_alvo && (
                      <div>
                        <b className="text-foreground">Público:</b> {f.publico_alvo}
                      </div>
                    )}
                    {f.segmento && (
                      <div>
                        <b className="text-foreground">Segmento:</b> {f.segmento}
                      </div>
                    )}
                    {f.responsavel && (
                      <div>
                        <b className="text-foreground">Responsável:</b> {f.responsavel}
                      </div>
                    )}
                  </div>
